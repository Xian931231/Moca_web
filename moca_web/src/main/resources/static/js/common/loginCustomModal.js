/**
 * login.css 적용 customModal
 */
const loginCustomModal = (function(){
	/**
	 * alert 
	 * option : {
	 *  title: 제목,
	...
	function confirm(option){ 
		...
		});
		{
			...
			}
			{
				...
				let cancel_o = $("<button>").addClass("modal-close-btn").attr({
					"type": "button",
					"data-dismiss": "modal"
				}).html("취소");
				...
				let confirm_o = $("<button>").addClass("modal-close-btn2").attr({
					"type": "button",
					"data-dissmiss": "modal",
				}).html("확인");
				footer_o.append(confirm_o);
