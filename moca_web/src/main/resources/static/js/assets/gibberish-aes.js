...
function getSecKey(){
	let defaultKey = "lTZiXyjWmtHsglnPkbtPi80wtUXwwMz1"; 
	...
	if(newSecKey != null) {
		sessionStorage.setItem("_newSecretKey", newSecKey);
		return newSecKey;
	}
	
	newSecKey = sessionStorage.getItem("_newSecretKey");
	if(newSecKey != null) {
		return newSecKey;
	}
