const supplyReportList = (() => {
	...
	function init() {
		_evInit();
		_setDatepicker();
		_list.getSupplyMemberList(function(){
	...
	let _event = {
		...
		excelDownload: function(){
			let url_v = "/report/agency/excel/bySupply";
	...
	let _list = {
		...
		getSupplyMemberList: function(callback){
			let url_v = "/report/agency/supply/member/list";
		...
		getSupplyReportList: function(){
			...
			let url_v = "/report/agency/list/bySupply";
